        ...
        DATA
__vector_table                                                                  //điểm bắt đầu của flash (0x0800'0000)
        DCD     sfe(CSTACK)                                                     //offset thứ 0
        DCD     Reset_Handler                   ; Reset Handler                 //offset thứ 4
        DCD     NMI_Handler                     ; NMI Handler                   //v..v...
        ...
        DCD     SysTick_Handler                 ; SysTick Handler               //offset thứ 0x3C có giá trị là địa chỉ của hàm SysTick_Handler
...
PendSV_Handler
        ...
        PUBWEAK SysTick_Handler                                                 //public weak
        SECTION .text:CODE:REORDER:NOROOT(1)
SysTick_Handler
        B SysTick_Handler
